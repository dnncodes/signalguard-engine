    ...
    extend: {
      ...
      colors: {
        ...
        engine: {
          ...
          "surface-hover": "hsl(var(--engine-surface-hover))",
          border: "hsl(var(--engine-border))",
          "border-hover": "hsl(var(--engine-border-hover))",
          "text-primary": "hsl(var(--engine-text-primary))",
          "text-secondary": "hsl(var(--engine-text-secondary))",
          "text-muted": "hsl(var(--engine-text-muted))",
          "text-dim": "hsl(var(--engine-text-dim))",
        },
        signal: {
